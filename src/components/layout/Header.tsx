...
import { Search, ShoppingCart, MapPin, User, Menu, X, History, ChevronDown } from 'lucide-react';
      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center justify-between py-2 text-sm border-b border-border/50">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link to="/history" className="flex items-center gap-1 hover:text-primary transition-colors">
          ...
          <div className="flex-1 max-w-2xl hidden md:block">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 pr-4 h-12 rounded-xl bg-secondary/50 border-0 focus-visible:ring-2 focus-visible:ring-primary"
              />
            </div>
          </div>
              ...
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === link.to
                    ...
                    : 'hover:bg-secondary',
                  link.highlight && location.pathname !== link.to && 'text-accent'
                )}
              >
                {link.label}
              </Link>
        ...
        <div className="md:hidden pb-4">
          <div className="relative">
            ...
            <Input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-12 pr-4 h-11 rounded-xl bg-secondary/50 border-0"
            />
          </div>
        </div>
          ...
          <nav className="lg:hidden py-4 border-t border-border animate-slide-up">
            <div className="flex flex-col gap-2">
              ...
              <Link
                to="/history"
                onClick={() => setIsMenuOpen(false)}
                className="px-4 py-3 rounded-lg font-medium hover:bg-secondary flex items-center gap-2"
              >
                <History className="w-4 h-4" />
                Order History
              </Link>
